...
void install(Runtime &jsiRuntime) {
    ...
    //     jsiRuntime, PropNameID::forAscii(jsiRuntime, "helloWorld"), 0,
    ...
    //         arguments[2].getObject(runtime).getFunction(runtime).call(runtime,
    //                                                                   x * y);
    ...
    //     jsiRuntime, PropNameID::forAscii(jsiRuntime, "foo"), 1,
    //     [](Runtime &runtime, const Value &thisValue, const Value *arguments,
    //        size_t count) -> Value {
    //         auto userCallbackRef =
    //             std::make_shared<Object>(arguments[0].getObject(runtime));
